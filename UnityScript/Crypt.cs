namespace Skynet
{
    ...
    public static class Crypt {
        ...
        public static byte[] HMAC64_str(string inputX, string inputY)
        {
            byte[] x = Encoding.ASCII.GetBytes(inputX);
            byte[] y = Encoding.ASCII.GetBytes(inputY);
            return HMAC64(x, y);
        }
        ...
        public static byte[] DHSecret_str(string inputX, string inputY)
        {
            byte[] x = Encoding.ASCII.GetBytes(inputX);
            byte[] y = Encoding.ASCII.GetBytes(inputY);
            return DHSecret(x, y);
